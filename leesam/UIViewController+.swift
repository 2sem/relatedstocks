...
extension UIViewController {
    ...
    func showAlert(title: String, msg: String, actions : [UIAlertAction], style: UIAlertControllerStyle, completion: (() -> Void)? = nil) -> UIAlertController{
...
//            print("childViewController filter \(view) == \(type)");
    ...
    func showCellularAlert(title: String, handler : ((UIAlertAction) -> Void)? = nil){
        self.showAlert(title: title, msg: "Turn on cellular data or use Wi-Fi to access data".localized(), actions: [UIAlertAction(title: "OK".localized(), style: .default, handler: handler)], style: .alert);
    }
