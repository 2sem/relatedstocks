...
extension UIApplication{
    func shareByKakao(){
        ...
        var kakaoContent = KMTContentObject.init { (builder) in
            ...
            builder.imageURL = URL(string: "https://is1-ssl.mzstatic.com/image/thumb/Newsstand122/v4/f4/82/d5/f482d52f-18e7-3bad-03b7-f93b01379478/Icon-76@2x.png.png/0x0ss.png")!;
        ...
        var kakaoTemplate = KMTFeedTemplate.init(builderBlock: { (kakaoBuilder) in
            ...
            kakaoBuilder.addButton(KMTButtonObject(builderBlock: { (buttonBuilder) in
                buttonBuilder.link = KMTLinkObject(builderBlock: { (linkBuilder) in
                    ...
                    linkBuilder.mobileWebURL = URL(string: "https://play.google.com/store/apps/details?id=kr.co.ncredif.stockseeker&hl=ko");
